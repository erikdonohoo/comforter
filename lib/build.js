...
module.exports = function (data) {
	...
	App.findOne({project_id: data.project}, function (err, app) {
	...
	.then(function (diff) {
		...
		return q({project: data.project, branch: data.branch, commit: data.commit, coverage: data.coverage, diff: diff, status: state});
	})
